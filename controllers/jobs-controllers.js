...
const getSpecificJob = async (req, res, next) => {
	...
	let foundJob;
	try {
		foundJob = await Job.findById(foundJobId).populate('companyId', '-password');
	} catch (err) {
		console.log(err);
...
const editJobDraft = async (req, res, next) => {
	...
	updatedJob.jobTitle = jobTitle ? jobTitle : updatedJob.jobTitle;
	updatedJob.placementLocation = placementLocation ? placementLocation : updatedJob.placementLocation;
	...
	updatedJob.emailRecipient = emailRecipient ? emailRecipient : updatedJob.emailRecipient;
	...
	updatedJob.benefit = benefit ? benefit : updatedJob.benefit;
	updatedJob.salary = salary ? salary : updatedJob.salary;
...
const updateJob = async (req, res, next) => {
	...
	const { jobDescriptions, salary, educationalStage, technicalRequirement, employment } = req.body;
	const jobId = req.params.jobid;
