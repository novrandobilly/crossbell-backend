...
const sentApplicantBC = async (req, res, next) => {
  ...
  const emailData = {
    ...
    subject: `Test Email Send  Bulk Candidate - Candidate ${foundCandidate.firstName} ${foundCandidate.lastName}`,
    text: `Test Email Send  Bulk Candidate - Candidate ${foundCandidate.firstName} ${foundCandidate.lastName}`,
    html: `
		<p>Ini contoh email sending candidate ke email ${foundOrder.emailRecipient} untuk applicant ${foundCandidate.firstName} ${foundCandidate.lastName} </p>
		`,
  };
